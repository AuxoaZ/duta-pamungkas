...
!(function (e) {
    ...
    e("#tv-nav-monthly").length &&
        (function () {
            ...
            ([t.monthly, t.yearly].forEach((e) =>
                ...
                t.switcher.on("click", () =>
                    o(!t.monthly.hasClass("is-active")),
                ));
        })();
    var t,
        ...
        e(window).on("scroll", function () {
            ...
            if (o.length) {
                ...
                e(window).scrollTop() > n
                    ? (o.addClass("scroll-on"),
                      t.length && t.css("height", a + "px"))
                    : (o.removeClass("scroll-on"),
                      t.length && t.css("height", "0"));
            }
        }),
    ...
    (document.querySelectorAll(".social-share .plus").forEach((e) => {
        ...
        e(".faq-accordion .accordion-collapse").on(
            "show.bs.collapse",
            function () {
