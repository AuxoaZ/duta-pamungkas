<section id="goods-type" class="goods-type-sec sec-padding overflow-hidden">
    <div class="container">
        <div class="sec-intro mx-auto text-center mb-5">
            <span class="sub-title fadeInUp">
                ...
                Jenis Barang</span
            >
            <h2 class="sec-title">Apa Saja yang Bisa Kami Kirim?</h2>
            <p class="sec-desc">
                Dari kendaraan bermotor hingga dokumen penting, kami siap mengirimkan
                berbagai jenis barang dengan aman dan terpercaya.
            </p>
        </div>
