    ...
    <div class="container">
        <div class="mb-5 pb-5 text-center">
            <span class="sub-title fadeInUp">
                ...
                How It Works</span
            >
            <h2 class="sec-title">Proses Pengiriman dalam 3 Langkah Mudah</h2>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="process-entry text-center fadeInUp" data-delay=".2">
                    ...
                    <p>
                        Kontak tim kami melalui telepon atau WhatsApp untuk
                        menyampaikan detail pengiriman
                    </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="process-entry text-center fadeInUp" data-delay=".4">
                    ...
                    <p>
                        Jadwalkan penjemputan barang sesuai waktu dan lokasi
                        yang diinginkan
                    </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="process-entry text-center fadeInUp" data-delay=".6">
                    ...
                    <p>
                        Kirimkan lokasi penjemputan agar tim kami dapat
                        mengambil barang dengan cepat dan tepat
                    </p>
                </div>
            </div>
        </div>
