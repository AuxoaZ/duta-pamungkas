<section
    id="contact"
    class="contact-sec overflow-hidden sec-padding position-relative"
>
    <div class="container">
        <div class="sec-intro mx-auto text-center">
            ...
            <p class="mt-3">
                Tim kami siap membantu kebutuhan pengiriman Anda. Silakan
        ...
        <div class="row g-4 align-items-stretch">
                ...
                <div class="card border-0 shadow-sm h-100 p-4 rounded-4">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mb-0 fw-medium">
                            Jalan, Gamping Lor, Ambarketawang, Gamping, Sleman
                            Regency, Special Region of Yogyakarta 55294
                        </p>
                    </div>

                    <div class="mb-4">
                        <small class="text-muted d-block">Email</small>
                        <p class="mb-0 fw-medium">dpat-cargo@gmail.com</p>
                        <p class="mb-0 fw-medium">masadit@gmail.com</p>
                    </div>

                    <div class="mb-4">
                        <small class="text-muted d-block">Telepon</small>
                        <p class="mb-0 fw-medium">0851-3856-8164</p>
                    </div>
            ...
            <div class="col-lg-7">
                ...
                >
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.2540935185943!2d110.33357537510942!3d-7.762855392256346!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a59e6e72b9163%3A0x11c52349066d1864!2sCV.%20Duta%20Pamungkas%20Abadi%20Translogistik!5e0!3m2!1sen!2sid!4v1771839765462!5m2!1sen!2sid"
                        height="450"
                        style="border: 0"
                        allowfullscreen=""
                        loading="lazy"
