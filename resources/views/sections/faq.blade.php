<section id="faq" class="faq-sec overflow-hidden sec-padding position-relative">
    <div class="container">
        <div class="sec-intro mx-auto text-center">
            <span class="sub-title fadeInUp">
                ...
                FAQ</span
            >
            <h2 class="sec-title">Pertanyaan yang Sering Diajukan</h2>
        </div>
        <div class="row gy-4">
            <div class="col-lg-6">
                <div class="faq-accordion rounded-4" id="tv-accordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button
                                class="accordion-button display-5 collapsed"
                                type="button"
