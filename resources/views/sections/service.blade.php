        ...
        <div class="d-flex justify-content-center gap-4 row">
            <div class="col-xl-3 col-md-6">
                <div
                    ...
                    style="background-image: url(&quot;{{
                        asset('assets/images/serv-truck.png')
                    }}&quot;)"
                >
                    <div class="serv-txt rounded-4">
                        ...
                        <p>
                            Pengiriman darat menggunakan kendaraan seperti truk
                            atau kereta untuk mengangkut barang. Metode ini
                            ekonomis dan efisien untuk jarak dekat hingga
                            menengah.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div
                    class="service-entry bg-cover round"
                    style="background-image: url(&quot;{{
                        asset('assets/images/serv-plane.png')
                    }}&quot;)"
                >
                    <div class="serv-txt rounded-4">
                        <div class="serv-heading">
                        ...
                        <p>
                            Pengiriman udara menggunakan pesawat terbang untuk
                            mengangkut barang. Metode ini cepat dan efisien
                            untuk pengiriman jarak jauh dan barang berharga.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div
                    class="service-entry bg-cover round"
                    style="background-image: url(&quot;{{
                        asset('assets/images/serv-ship.png')
                    }}&quot;)"
                >
                    <div class="serv-txt rounded-4">
                        <div class="serv-heading">
