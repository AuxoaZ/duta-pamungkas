<section id="service" class="services-3 sec-padding overflow-hidden">
    <div class="container">
        ...
        <div class="service-grid service-grid-3">
            ...
            <div class="service-card-new">
                <div class="service-card-img">
                    <img
                        ...
                        alt="Pengiriman Darat"
                        class="img-fluid"
                    />
                    <div class="service-card-badge">Populer</div>
                </div>
                <div class="service-card-body">
                    ...
                    <p>
                        Pengiriman darat menggunakan armada truk dan kendaraan
                        terpercaya. Solusi ekonomis dan efisien untuk pengiriman
                        jarak dekat hingga menengah di seluruh Indonesia.
                    </p>
                    <ul class="service-features">
                        <li><i class="fa fa-check"></i> Ekonomis & efisien</li>
                        <li><i class="fa fa-check"></i> Jarak dekat - menengah</li>
            ...
            <div class="service-card-new">
                <div class="service-card-img">
                    <img
                        src="{{ asset('assets/images/serv-plane.png') }}"
                        alt="Pengiriman Udara"
                        class="img-fluid"
                    />
                    <div class="service-card-badge">Tercepat</div>
                </div>
                <div class="service-card-body">
                    <div class="service-card-icon">
                    ...
                    <p>
                        Pengiriman via udara menggunakan pesawat kargo untuk
                        kecepatan maksimal. Ideal untuk barang berharga dan
                        pengiriman jarak jauh dengan waktu terbatas.
                    </p>
                    <ul class="service-features">
                        <li><i class="fa fa-check"></i> Pengiriman tercepat</li>
                        <li><i class="fa fa-check"></i> Jarak jauh & antar pulau</li>
                        <li><i class="fa fa-check"></i> Barang berharga aman</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="service-card-new">
                <div class="service-card-img">
                    <img
                        src="{{ asset('assets/images/serv-ship.png') }}"
                        alt="Pengiriman Laut"
                        class="img-fluid"
                    />
                    <div class="service-card-badge">Muatan Besar</div>
                </div>
                <div class="service-card-body">
                    <div class="service-card-icon">
                    ...
                    <p>
                        Pengiriman laut menggunakan kapal kargo untuk muatan
                        besar dan berat. Cocok untuk kebutuhan distribusi skala
                        besar dan perdagangan antar pulau.
                    </p>
                    <ul class="service-features">
                        <li><i class="fa fa-check"></i> Kapasitas besar</li>
                        <li><i class="fa fa-check"></i> Antar pulau & internasional</li>
                        <li><i class="fa fa-check"></i> Hemat untuk volume besar</li>
                    </ul>
                </div>
            </div>
        </div>
